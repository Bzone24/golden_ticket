                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text"
                                   ...
                                   class="form-control"
                                   placeholder="Choose a username (e.g. ram123)">
                            @error('username')
                            ...
                            <div id="usernameWarning" class="mt-1" style="display:none;">
                                <small class="text-danger">Usernames that look like <code>ABC123</code> are reserved. Please choose a different username.</small>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card p-2 h-100">
                                                <div class="card-body p-2">
                                                    ...
                                                    <div class="mb-2">
                                                        <label for="maximum_cross_amount_{{ $gk }}" class="form-label">Maximum Cross Amount ({{ $gk }})</label>
                                                        <input type="number"
       id="maximum_cross_amount_{{ $game->id }}"
       wire:model.defer="per_game_limits.{{ $game->id }}.maximum_cross_amount"
       class="form-control"
       placeholder="Maximum Cross Amount">
...
@enderror
                                                    ...
                                                    <div class="mb-0">
                                                        <label for="maximum_tq_{{ $gk }}" class="form-label">Maximum Tq ({{ $gk }})</label>
                                                       <input type="number"
       id="maximum_tq_{{ $game->id }}"
       wire:model.defer="per_game_limits.{{ $game->id }}.maximum_tq"
       class="form-control"
       placeholder="Maximum Tq">
...
@enderror
                    ...
                    <div class="form-group mt-3">
                        ...
                        <div class="d-flex gap-4 flex-wrap">
                            @foreach($games as $game)
                                <label class="form-check-label d-flex align-items-center" style="font-size: 1.1rem;">
                                    <input type="checkbox"
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-end">
                            <button type="submit" id="shopkeeperSubmit" class="btn btn-primary rounded-pill">Submit</button>
                        </div>
                    </div>
